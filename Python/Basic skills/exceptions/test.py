...
def addition_from_string(s):
    # All operation_from_string functions use the operation sign
    # as the median point in the string stripping - resulting
    # in a string such as '46+12' from 'abc 46 + 12 xyz' 
